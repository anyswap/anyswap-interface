...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    primary3: darkMode ? '#4D8FEA' : '#734ce2',
    primary4: darkMode ? '#376bad70' : '#734ce2',
    primary5: darkMode ? '#153d6f70' : '#734ce2',

    // color text
    primaryText1: darkMode ? '#6da8ff' : '#fff',

    // secondary colors
    secondary1: darkMode ? '#2172E5' : '#fff',
    secondary2: darkMode ? '#17000b26' : '#734ce2',
    secondary3: darkMode ? '#17000b26' : '#734ce2',
