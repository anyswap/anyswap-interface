...
import { Currency, currencyEquals, ETHER, Percent, WETH } from 'anyswap-sdk'
...
export default function RemoveLiquidity({
  ...
  const [approval, approveCallback] = useApproveCallback(parsedAmounts[Field.LIQUIDITY], config.swapRouterToken)
  ...
  async function onAttemptToApprove() {
    ...
    const message = {
      owner: account,
      spender: config.swapRouterToken,
      ...
      <>
        <RowBetween>
          <Text color={theme.text2} fontWeight={500} fontSize={16}>
            {config.baseCurrency + ' ' + config.getBaseCoin(currencyA?.symbol) + '/' + config.getBaseCoin(currencyB?.symbol)} Burned
          </Text>
          <RowFixed>
